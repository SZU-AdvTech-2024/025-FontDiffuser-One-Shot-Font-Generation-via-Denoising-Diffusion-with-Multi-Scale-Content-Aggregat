...
def save_single_image(save_dir, image):
    ...
    save_path = "/home/zjm/FontDiffuser/output_imgs/out_single.png"
    image.save(save_path)
...
def save_image_with_content_style(save_dir, image, content_image_pil, content_image_path, style_image_path, resolution):
    ...
    content_image_save_path = f"{save_dir}/out_cs.png"
    resize_content_image = content_image.resize((resolution, resolution), Image.BILINEAR)
    resize_content_image.save(content_image_save_path)

    content_image_save_path = "/home/zjm/FontDiffuser/real_imgs/out_cs.png"
    resize_content_image.save(content_image_save_path)

    new_image.paste(resize_content_image, (0, 0))
